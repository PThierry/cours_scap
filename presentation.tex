...
\begin{frame}
  \begin{block}{Les sélecteurs OVAL}
    \begin{itemize}
	    \item Des politiques de sécurités de plus haut niveau (comme clles du NIST) peuvent impliquer plusieurs STIGs
  ...
  \end{block}
    ...
    \begin{itemize}
	    \item La présence d'un sélecteur correspond à la présence d'une variable dans un test
